...
No internal subsystem is exempt from declared responsibility, dependency direction, side-effect policy, evidence requirements, architecture diff, or explicit exceptions.
