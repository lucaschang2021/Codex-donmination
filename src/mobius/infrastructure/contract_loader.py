...
def load_contract(path: Path) -> ArchitectureContract:
    ...
    constraints = Constraints(
        forbid_module_mutable_state=raw_constraints.get("forbid_module_mutable_state", True),
        ...
        core_requires_isolated_unit_tests=raw_constraints.get("core_requires_isolated_unit_tests", True),
        fake_external_providers_required=raw_constraints.get("fake_external_providers_required", True),
        architecture_gate_required=raw_constraints.get("architecture_gate_required", True),
    )
